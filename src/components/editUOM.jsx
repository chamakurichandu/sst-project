...
export default function EditUOM(props) {
    ...
    const [name, set_name] = React.useState(props.uom.name);
    ...
    const handleSave = async () => {
        try {
            ...
            let url = config["baseurl"] + "/api/uom/update";

            let postObj = {};
            postObj["name"] = name;

            let updateObj = { _id: props.uom._id, updateParams: postObj };
