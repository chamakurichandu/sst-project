...
function EnhancedTableHead(props) {
  ...
  const headCells = [
    ...
    { id: 'install_qty', numeric: false, disablePadding: false, label: 'Installation Quantity' },
    { id: 'testing_qty', numeric: false, disablePadding: false, label: 'Testing Quantity' }
  ];
...
export default function WorkCommissioning(props) {
        ...
        <Paper className={classes.grid}>
          <Grid container spacing={2}>
            <Grid item className={classes.totalAttendes}>
              ...
              <span>{"Materials in Testing"}</span>
            </Grid>
            <Grid item className={classes.addButton}>
              {!editMode && <Button onClick={() => handleComplete()} style={{ background: "#314293", color: "#FFFFFF", marginLeft: 5 }} variant="contained" className={classes.button}>{"Complete Commissioning & Testing"}</Button>}
              <Button onClick={() => handleSave()} style={{ marginLeft: 10, background: "#314293", color: "#FFFFFF" }} variant="contained" className={classes.button}>{editMode ? "Save Testing" : "Edit Testing"}</Button>
                  ...
                  return (
                    <TableRow hover tabIndex={-1} key={labelId}>
                      ...
                      <TableCell align={dir === 'rtl' ? 'right' : 'left'} >
                        <TextField size="small" id={"formControl_qty_" + index} type="number" value={row.install_qty} variant="outlined" disabled />
                      </TableCell>
                      <TableCell align={dir === 'rtl' ? 'right' : 'left'} >
