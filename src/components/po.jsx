...
export default function PO(props) {
  ...
  const downloadAction = async (data) => {
    ...
    data.items.forEach(function (item, index) {
      ...
      const dateFns = new DateFnsUtils();
      if (!(completeItem?completeItem.hsncode:false))
      ...
      content: [
        {
          ...
          table: {
            ...
            body: [
              [{ text: 'Purchase Order', style: 'tableHeader', colSpan: 4, alignment: 'center' }, {}, {}, {}],
              ...
              [{ text: 'PO Number:', bold: true, fontSize: 10, alignment: 'center' }, { text: data.code, bold: false, fontSize: 10, alignment: 'center' }, { text: 'Reference Number:', bold: true, fontSize: 10, alignment: 'center' }, { text: data.reference_number, bold: false, fontSize: 10, alignment: 'center' }],
        ...
        <Paper className={classes.grid}>
          <Grid container spacing={2}>
            ...
            <Grid item className={classes.addButton}>
              <Button onClick={() => handleAdd()} style={{ background: "#314293", color: "#FFFFFF" }} variant="contained" className={classes.button}>{"Add PO"}</Button>
            </Grid>
          </Grid>
        </Paper>
        <Paper className={classes.grid}>
