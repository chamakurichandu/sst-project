...
function EnhancedTableHead(props) {
  ...
  const headCells = [
    ...
    { id: 'exhibitor_name', numeric: false, disablePadding: false, label: 'Mentor Name' },
    { id: 'website', numeric: false, disablePadding: false, label: 'Status' },
    { id: 'visit_stall', numeric: false, disablePadding: false, label: 'Apply for mentoring' },
  ];
...
export default function Mentors(props) {
  ...
  useEffect(() => {
    ...
    props.getListOfAppliedMentoring();
  }, []);
  ...
  const mentorshipApplyFormOpen = (row) => {
  ...
  const mentorshipApplyFormApply = (message) => {
    setShowApplyForm(false);
    console.log("currentRow.user_id: ", currentRow.user_id);
    console.log("message: ", message);
    props.applyForMentoring(currentRow.user_id, message);
    // props.applyForMentoring("ap-south-1_EH6LoIlGK:61fe920d-1dea-44c2-a727-ec6ea18a3389", message);
  };
    ...
    <div className={clsx(classes.root)}>
      {props.refreshUI &&
        ...
        <div className={classes.paper}>
          <EnhancedTableToolbar title='Mentors' />
                ...
                <div>
                  <div className={classes.total}>
                    <span className={classes.totalDetails}>
                      ...
                      Mentored from {totalMentored}</span>
                    <span className={classes.totalDetails}>
                      <span className={classes.dot}></span>
                      To be mentored from {totalCount} </span>
                  </div>
                  <BorderLinearProgress variant="determinate" value={(totalMentored / totalCount) * 100.0} />
                </div>
              </Grid>
            </Grid>
          </Paper>
                        ...
                        >
                          ...
                          <TableCell align={dir === 'rtl' ? 'right' : 'left'}>
                            <div className={classes.flex}>
                              <Image
                                src={logos[index]}
                                NativeImgProps={{ className: classes.exhibitor_image, width: 50, height: 50 }}
                          ...
                          <TableCell align={dir === 'rtl' ? 'right' : 'left'}>{props.mentorAppliedRequests.includes(row.user_id) ? "applied" : "--"}</TableCell>
                          <TableCell align={dir === 'rtl' ? 'right' : 'left'}>
                            <div style={{ paddingTop: 10 }}><Button onClick={() => mentorshipApplyFormOpen(row)} style={{ background: "#314293", color: "#FFFFFF" }} variant="contained" className={classes.button}>Apply</Button></div>
                          </TableCell>
                        </TableRow>
                      );
                    })}
          ...
          {showApplyForm && <MentoringApplyForm mentorshipApplyFormClose={mentorshipApplyFormClose} mentorshipApplyFormApply={mentorshipApplyFormApply} />}
        </div>
